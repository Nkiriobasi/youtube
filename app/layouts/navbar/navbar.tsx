        ...
        <div className="h-auto py-2 px-4 flex flex-row items-center justify-between">
            ...
            <div className="w-[177px] flex flex-row items-center h-full">
                ...
                <div className="w-[129px] h-full flex relative">
                                    ...
                                    <div className="flex justify-center items-center w-full h-full">
                                        <div className="w-full h-full fill-current">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="90" height="20" viewBox="0 0 90 20" fill="none">
                                                ...
                                                <path d="M34.6024 13.0036L31.3945 1.41846H34.1932L35.3174 6.6701C35.6043 7.96361 35.8136 9.06662 35.95 9.97913H36.0323C36.1264 9.32532 36.3381 8.22937 36.665 6.68892L37.8291 1.41846H40.6278L37.3799 13.0036V18.561H34.6001V13.0036H34.6024Z" className='dark:fill-white fill-black'/>
                                                <path d="M41.4698 18.1937C40.9054 17.8127 40.5032 17.22 40.2633 16.4157C40.0258 15.6114 39.9059 14.5437 39.9059 13.2078V11.3898C39.9059 10.0422 40.0423 8.95805 40.3151 8.14196C40.5879 7.32588 41.0136 6.72851 41.5921 6.35457C42.1707 5.98063 42.9303 5.79248 43.8711 5.79248C44.7977 5.79248 45.5385 5.98298 46.0982 6.36398C46.6556 6.74497 47.0648 7.34234 47.3235 8.15137C47.5822 8.96275 47.7116 10.0422 47.7116 11.3898V13.2078C47.7116 14.5437 47.5846 15.6161 47.333 16.4251C47.0813 17.2365 46.6721 17.8292 46.1076 18.2031C45.5432 18.5771 44.7765 18.7652 43.8099 18.7652C42.8127 18.7675 42.0343 18.5747 41.4698 18.1937ZM44.6354 16.2323C44.7906 15.8231 44.8706 15.1575 44.8706 14.2309V10.3292C44.8706 9.43077 44.793 8.77225 44.6354 8.35833C44.4778 7.94206 44.2027 7.7351 43.8075 7.7351C43.4266 7.7351 43.1561 7.94206 43.0009 8.35833C42.8433 8.77461 42.7657 9.43077 42.7657 10.3292V14.2309C42.7657 15.1575 42.8409 15.8254 42.9915 16.2323C43.142 16.6415 43.4124 16.8461 43.8075 16.8461C44.2027 16.8461 44.4778 16.6415 44.6354 16.2323Z" className='dark:fill-white fill-black' />
                                                <path d="M56.8154 18.5634H54.6094L54.3648 17.03H54.3037C53.7039 18.1871 52.8055 18.7656 51.6061 18.7656C50.7759 18.7656 50.1621 18.4928 49.767 17.9496C49.3719 17.4039 49.1743 16.5526 49.1743 15.3955V6.03751H51.9942V15.2308C51.9942 15.7906 52.0553 16.188 52.1776 16.4256C52.2999 16.6631 52.5045 16.783 52.7914 16.783C53.036 16.783 53.2712 16.7078 53.497 16.5573C53.7228 16.4067 53.8874 16.2162 53.9979 15.9858V6.03516H56.8154V18.5634Z" className='dark:fill-white fill-black' />
                                                <path d="M64.4755 3.68758H61.6768V18.5629H58.9181V3.68758H56.1194V1.42041H64.4755V3.68758Z" className='dark:fill-white fill-black' />
                                                <path d="M71.2768 18.5634H69.0708L68.8262 17.03H68.7651C68.1654 18.1871 67.267 18.7656 66.0675 18.7656C65.2373 18.7656 64.6235 18.4928 64.2284 17.9496C63.8333 17.4039 63.6357 16.5526 63.6357 15.3955V6.03751H66.4556V15.2308C66.4556 15.7906 66.5167 16.188 66.639 16.4256C66.7613 16.6631 66.9659 16.783 67.2529 16.783C67.4974 16.783 67.7326 16.7078 67.9584 16.5573C68.1842 16.4067 68.3488 16.2162 68.4593 15.9858V6.03516H71.2768V18.5634Z" className='dark:fill-white fill-black' />
                                                <path d="M80.609 8.0387C80.4373 7.24849 80.1621 6.67699 79.7812 6.32186C79.4002 5.96674 78.8757 5.79035 78.2078 5.79035C77.6904 5.79035 77.2059 5.93616 76.7567 6.23014C76.3075 6.52412 75.9594 6.90747 75.7148 7.38489H75.6937V0.785645H72.9773V18.5608H75.3056L75.5925 17.3755H75.6537C75.8724 17.7988 76.1993 18.1304 76.6344 18.3774C77.0695 18.622 77.554 18.7443 78.0855 18.7443C79.038 18.7443 79.7412 18.3045 80.1904 17.4272C80.6396 16.5476 80.8653 15.1765 80.8653 13.3092V11.3266C80.8653 9.92722 80.7783 8.82892 80.609 8.0387ZM78.0243 13.1492C78.0243 14.0617 77.9867 14.7767 77.9114 15.2941C77.8362 15.8115 77.7115 16.1808 77.5328 16.3971C77.3564 16.6158 77.1165 16.724 76.8178 16.724C76.585 16.724 76.371 16.6699 76.1734 16.5594C75.9759 16.4512 75.816 16.2866 75.6937 16.0702V8.96062C75.7877 8.6196 75.9524 8.34209 76.1852 8.12337C76.4157 7.90465 76.6697 7.79646 76.9401 7.79646C77.2271 7.79646 77.4481 7.90935 77.6034 8.13278C77.7609 8.35855 77.8691 8.73485 77.9303 9.26636C77.9914 9.79787 78.022 10.5528 78.022 11.5335V13.1492H78.0243Z" className='dark:fill-white fill-black' />
                    ...
                    <span 
                        className="dark:text-[#aaa] text-black text-[9px] absolute top-[-5px] right-0"
                    >
                        NG
                    </span>
                </div>
            ...
            <div className="min-w-0 flex flex-row items-center flex-[0_1_732px]">
                ...
                <div className="ml-[12px] rounded-[100px] dark:bg-[#ffffff1a] hover:opacity-80 bg-[#eee]" title='Search with your voice'>
                    <div className="inline-block">
                        <div className="flex">
                            <button 
                                className="dark:text-[#f1f1f1] text-black min-w-0 rounded-[50%] w-10 h-10 p-0 
            ...
            <div className="min-w-[225px] flex flex-row items-center justify-end">
                ...
                <div className="flex flex-row items-center">
                    {/* Create New Video */}
                    <div className="dark:text-white text-black outline-none mr-2 flex" title='Create'>
                        <div>
                                ...
                                <div className="relative inline-block leading-none p-2">
                                    <button className="align-middle cursor-pointer w-full h-full">
                                        <div className="inline-flex items-center justify-center relative align-middle fill-current">
                                            <div className="w-full h-full flex items-center justify-center">
                                                <svg height="24" className='block w-full h-full pointer-events-none dark:text-white text-black' viewBox="0 0 24 24" width="24" focusable="false"><path d="M14 13h-3v3H9v-3H6v-2h3V8h2v3h3v2zm3-7H3v12h14v-6.39l4 1.83V8.56l-4 1.83V6m1-1v3.83L22 7v8l-4-1.83V19H2V5h16z"></path></svg>
                                            </div>
                                        </div>
                                    </button>
                                </div>
                    ...
                    {/* Notification */}
                    <div className="dark:text-white text-black outline-none mr-2 flex" title='Notifications'>
                        <div>
                            <div className="text-inherit cursor-pointer flex hover:dark:bg-[#ffffff1a] hover:bg-[#eee] rounded-[50%]">
                                <div className="relative inline-block leading-none p-2">
                                    <div className="align-middle cursor-pointer w-6 h-6">
                                        <div className="inline-flex items-center justify-center relative align-middle fill-current">
                                            <div className="w-full h-full flex items-center justify-center">
                                                <svg enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false" className='block w-full h-full pointer-events-none dark:text-white text-black'><path d="M10 20h4c0 1.1-.9 2-2 2s-2-.9-2-2zm10-2.65V19H4v-1.65l2-1.88v-5.15C6 7.4 7.56 5.1 10 4.34v-.38c0-1.42 1.49-2.5 2.99-1.76.65.32 1.01 1.03 1.01 1.76v.39c2.44.75 4 3.06 4 5.98v5.15l2 1.87zm-1 .42-2-1.88v-5.47c0-2.47-1.19-4.36-3.13-5.1-1.26-.53-2.64-.5-3.84.03C8.15 6.11 7 7.99 7 10.42v5.47l-2 1.88V18h14v-.23z"></path></svg>
                                            </div>
                                        </div>
                                    </div>
                                    <div 
